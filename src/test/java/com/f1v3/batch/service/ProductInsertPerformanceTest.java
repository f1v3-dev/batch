...
@SpringBootTest
@ActiveProfiles("test")
class ProductInsertPerformanceTest {
    ...
    @Test
    @DisplayName("JPA saveAll() 성능 테스트 - rewriteBatchedStatements=false")
    void testJpaSaveAllPerformance() {
        System.out.println("=== JPA saveAll() 성능 테스트 시작 (rewriteBatchedStatements=false) ===");
    ...
    @Test
    @DisplayName("JDBC Statement 성능 테스트 - rewriteBatchedStatements=false")
    void testJdbcStatementPerformance() {
        System.out.println("=== JDBC Statement 성능 테스트 시작 (rewriteBatchedStatements=false) ===");
    ...
    @Test
    @DisplayName("JDBC PreparedStatement 성능 테스트 - rewriteBatchedStatements=false")
    void testJdbcPreparedStatementPerformance() {
        System.out.println("=== JDBC PreparedStatement 성능 테스트 시작 (rewriteBatchedStatements=false) ===");
